...
captured: 2026-09-05
provenance: >
  Pasted verbatim by Thức after the agent could not reach the page (egress
  blocked). This file supersedes
  `sources/2026-09-05-ng-ai-engineering-skills-map.md`, which was a
  search-summary capture and is kept only as a record of that error.
---
